  ...
  return (
    <div className="mx-auto w-full max-w-[1100px] space-y-4 sm:space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-[18px] font-bold text-brand-600 sm:text-xl">All FAQs</h2>
          <p className="mt-0.5 text-[12.5px] text-surface-muted">
            Manage frequently asked questions shown in the FAQ section.
          </p>
        </div>
        <Link
          to="/faq/add-faq"
      ...
      {faqs.length === 0 ? (
        <div className="rounded-xl2 border border-dashed border-surface-border bg-white p-10 text-center">
          <p className="text-[13.5px] font-medium text-surface-heading">No FAQs yet</p>
          <p className="mt-1 text-[12.5px] text-surface-muted">
            Add your first FAQ to see it listed here.
          </p>
        </div>
      ) : (
              ...
              <li key={faq.id} className="p-5">
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div className="min-w-0">
                    <p className="text-[14px] font-semibold text-surface-heading">{faq.question}</p>
